...
model = SimpleCNN()
print(model)
make_dot(model(torch.randn(1, 3, 32, 32)), params=dict(model.named_parameters()))2

# CV - ResNetimport torch
...
# model = SimpleLSTM(input_size=100, hidden_size=128, output_size=10)
# print(model)
...
class TransformerModel(nn.Module):
    def __init__(self, input_dim, model_dim, num_heads, num_layers, output_dim):
        ...
        self.positional_encoding = self._positional_encoding(model_dim)
    ...
    def _positional_encoding(self, model_dim):
...
# model = TransformerModel(input_dim=10000, model_dim=512, num_heads=8, num_layers=6, output_dim=10)
# print(model)
